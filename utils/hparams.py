...
def set_hparams(config='', exp_name='', hparams_str='',
                infer=False, validate=False,
                reset=False, debug=False, remove=False,
                print_hparams=True, global_hparams=True,
                command_line=True):
    if command_line and config == '' and exp_name == '':
        ...
        args = Args(config=config, exp_name=exp_name, hparams=hparams_str,
                    infer=infer, validate=validate, reset=reset, debug=debug, remove=remove)
    global hparams
